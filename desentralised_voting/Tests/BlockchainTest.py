...
class TestBlockchain(TestCase):
    ...
    def test_getting_longest_chain_contents(self):
        bc = Blockchain('root_content', 'root_hash')
        block02 = self.create_block_on(bc.init_block, '02', 'content02', 2)
        block01 = self.create_block_on(bc.init_block, '01', 'content01', 1)
        block12 = self.create_block_on(block01, '12', 'content12', 2)
    ...
    @staticmethod
    def create_block_on(parent, block_hash, content, step) -> ChainBlock:
